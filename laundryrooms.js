...
//         .replace(/\s/g, '')
//         .toLowerCase()
//     db.collection('assignments').add(assignment,la )
//     //db.collection('assignments').doc('mykey-1').set( assignment )
//     //console.log(assignments)
// }



export default generateAssigments
//export default generateAssigmentList